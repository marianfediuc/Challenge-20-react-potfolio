...
import Resume from '../../assets/images/Marian Fediuc - Resume.pdf'
...
return (
    <section>
        ...
        <Row>
            <Col lg={3} md={12}>
            <a href="https://github.com/marianfediuc"><img src="https://img.icons8.com/doodle/100/000000/github--v1.png" alt="github-logo" class="icon"/></a><p class="icon-text">github</p>
            </Col>

            <Col lg={3} md={12}>
            <a href="linkedin.com/in/marian-fediuc-croitoru-7a3b2a179"><img src="https://img.icons8.com/doodle/100/000000/linkedin--v2.png" alt="linkedin-logo" class="icon"/></a><p class="icon-text">linkedin</p>
            </Col>

            <Col lg={3} md={12}>
            <a href="marianfediuc15@gmail.com"><img src="https://img.icons8.com/doodle/120/000000/new-post.png" alt="mail-logo"/></a><p class="icon-text">email</p>
            </Col>
